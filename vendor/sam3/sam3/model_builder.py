...
def _resource_path(*parts: str) -> str:
    """Filesystem path to a package resource (replaces pkg_resources)."""
    return str(_pkg_files("sam3").joinpath(*parts))
...
def build_sam3_image_model(
    ...
    """
    if bpe_path is None:
        bpe_path = _resource_path("assets", "bpe_simple_vocab_16e6.txt.gz")
